...
const JUNE: SanctoraleEntry[] = [
  ...
  { m: 6, d: 17, cls: 3, color: 'white', la: 'S. Gregorii Barbadici ep. conf.', de: 'Hl. Gregor Barbarigo' },
...
const AUGUST: SanctoraleEntry[] = [
  ...
  { m: 8, d: 6, cls: 2, color: 'white', la: 'In Transfiguratione D.N.I.C.', de: 'Verklärung des Herrn', comm: [{ la: 'Ss. Xysti II papæ, Felicissimi et Agapiti mart.', de: 'Hll. Sixtus II. u. Gefährten' }] },
  ...
  { m: 8, d: 16, cls: 2, color: 'white', la: 'S. Ioachim patris B.M.V. conf.', de: 'Hl. Joachim, Vater Mariens' },
...
const SEPTEMBER: SanctoraleEntry[] = [
  ...
  { m: 9, d: 24, cls: 4, color: 'white', la: 'B.M.V. de Mercede', de: 'Unsere Liebe Frau von der Erlösung der Gefangenen' },
...
const OCTOBER: SanctoraleEntry[] = [
  ...
  { m: 10, d: 8, cls: 3, color: 'white', la: 'S. Birgittæ vid.', de: 'Hl. Birgitta von Schweden', comm: [{ la: 'Ss. Sergii, Bacchi, Marcelli et Apuleii mart.', de: 'Hll. Sergius, Bacchus u. Gefährten' }] },
  ...
  { m: 10, d: 26, cls: 4, color: 'red', la: 'S. Evaristi papæ mart.', de: 'Hl. Papst Evaristus' },
